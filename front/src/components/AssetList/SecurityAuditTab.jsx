            ...
            <div className="asset-table-container">
                <table className="assets-table">
                    ...
                    <tr>
                        ...
                        <th onClick={() => handleSort("asset_value")} style={{ cursor: "pointer" }}>
                            Asset Value {renderSortIcon("asset_value")}
                        </th>
                        <th>Description</th>
                        <th>Actions</th>
                    </tr>
                            ...
                            <td>
                                {asset.description ? (
                                    <button
                                        className="btn-icon"
                                        onClick={() => {
                                            setSelectedDescription(asset.description);
                                            setSelectedAssetName(asset.asset_name);
                                        }}
