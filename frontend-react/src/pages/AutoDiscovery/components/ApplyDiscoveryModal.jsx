/**
 * ApplyDiscoveryModal - Modal for applying discovery results with different modes
 *
 * Modes:
 * 1. Overwrite - Replace all existing data with discovered data
 * 2. Merge - Keep existing data + add new discovered data
 * 3. Create New - Create a new asset with discovered data
 */
