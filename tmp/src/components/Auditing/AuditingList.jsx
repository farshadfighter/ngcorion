...
export const AuditingList = () => {
    ...
    const handleDeleteConfirm = async () => {
        if (sessionToDelete) {
            await dispatch(deleteAuditSession(sessionToDelete.session_id));
    ...
    return (
        <div className="auditing-container">
            ...
            <div className="auditing-header">
                ...
                >
                    <img src="/icons/auditing-white.svg" alt="" className="btn-icon" />
                    Auditing
                </button>
            </div>
                                        ...
                                        <div className="table-actions">
                                            <div style={{ minWidth: '140px' }}>
                                                {session.status === "completed" && (
                                                    ...
                                                    >
                                                        <img src="/icons/eye.svg" alt="" className="btn-action-icon" />
                                                        See Result
                                                    </button>
                                                )}
                                            </div>
