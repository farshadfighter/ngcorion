...
> **⚠️ منسوخ (superseded):** این گزارش، عکس‌فوری وضعیت در تاریخ بالا است، وقتی
> فرمول ریسک هنوز چهارمؤلفه‌ای (`0.25C+0.20Z+0.15P+0.40A`) بود. از آن زمان
> فرمول به شش‌مؤلفه‌ای مطابق اسپک بازگردانده شده (AC/AR/AZ/OP/AF/HF،
> ۲۰/۲۰/۱۵/۱۰/۲۵/۱۰) و سطوح ریسک هم با بخش ۱۰ اسپک (informational/low/medium/
> high/critical، کران‌های ۲۱/۴۱/۶۱/۸۱) هم‌راستا شده‌اند. برای وضعیت فعلی به
> `docs/RISK_MODULE_GUIDE.md` مراجعه کنید؛ متن زیر فقط برای تاریخچه نگه داشته
> شده و توصیف فرمول/سطوح فعلی نیست.
