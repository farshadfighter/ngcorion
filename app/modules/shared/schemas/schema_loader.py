...
class SchemaLoader:
    ...
    # Mapping of device type to schema file path (relative to modules directory)
    SCHEMA_PATHS = {
        "cisco": "../../cisco/hardening/schemas/controls.json",
        "fortinet": "../../fortinet/hardening/schemas/controls.json",
        "linux": "../../linux/hardening/schemas/controls.json",
        "windows": "../../windows/hardening/schemas/controls.json",
        "apache": "../../apache/hardening/schemas/controls.json",
    }
