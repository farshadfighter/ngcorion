...
=======
    # Exclusive lower bound of each level (PDF section 10), evaluated high->low:
...
class AssetRiskCalculationService:
    ...
    def _risk_level(self, score: float, settings: dict) -> str:
        ...
        Thresholds are *exclusive* lower bounds: a score sitting exactly on a
        band boundary belongs to the lower band, so 20 is Informational, 40 is
        Low, 60 is Medium and 80 is High (the final score is rounded to an
        integer before this runs).
        """
